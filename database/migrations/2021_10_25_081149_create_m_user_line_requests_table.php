...
class CreateMUserLineRequestsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('m_user_line_requests', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('voip_line_id')->nullable();
    ...
    {
        Schema::dropIfExists('m_user_line_requests');
    }
}
