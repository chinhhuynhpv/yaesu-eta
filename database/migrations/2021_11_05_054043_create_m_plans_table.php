...
class CreateMPlansTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('m_plans', function (Blueprint $table) {
            $table->id();
            ...
            $table->decimal('midway_cancell_unit_price', 13, 0)->nullable();
            $table->timestamps();
            $table->softDeletes();
        });
    }
