    ...
    <table class="table mt-3" style="width: auto;">
        <tbody>
            <tr>
                ...
                <td>{{$billing->user->contract_name}}</td>
            </tr>
            <tr>
            ...
            <tr>
                <td>{{__("Billing Total")}}</td>
                <td class="text-right">{{number_format($billing->billing_total_price)}}</td>
            </tr>
            <tr>
                <td>{{__("Incentive Total")}}</td>
                <td class="text-right">{{number_format($billing->incentive_total_price)}}</td>
            </tr>
            <tr>
                <td>{{__("Status")}}</td>
                <td>{{$billing->getStatusColumn()}}</td>
            </tr>
        </tbody>
    </table>
