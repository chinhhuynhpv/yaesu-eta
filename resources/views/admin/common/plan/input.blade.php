    ...
    <div class="mt-5 mb-5">
        ...
        <form method="post" action="{{route("{$prefixRouteName}HandleInput")}}">
            ...
            <div class="form-group">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <input type="radio" name="calculation_unit" value="1" {{!$item->calculation_unit || $item->calculation_unit == 'line' ? 'checked' : ''}}> {{__("Line")}}
                    </div>
                    <div class="col-md-4">
                        <input type="radio" name="calculation_unit" value="2" {{$item->calculation_unit == 'application' ? 'checked' : ''}}> {{__("Application")}}
                    </div>
                </div>
            </div>
            <div class="form-group">
            ...
            @endif
            <div>
                <a class="btn btn-cancel btn-square" href="{{route("{$prefixRouteName}List")}}">{{__("Cancel")}}</a>
