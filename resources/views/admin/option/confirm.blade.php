    ...
    <div class="mt-5 mb-5">
        ...
        <form method="post" action="{{route("{$prefixRouteName}HandleConfirm")}}">
            ...
            <div class="form-group">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <input onclick="return false;" type="radio" name="option_type" value="1" {{$item->getRawValue('option_type') == '1' ? 'checked' : ''}}>
                        {{__("Function")}}
                    </div>
                    <div class="col-md-4">
                        <input onclick="return false;" type="radio" name="option_type" value="2" {{$item->getRawValue('option_type') == '2' ? 'checked' : ''}}>
                        {{__("Discount")}}
                    </div>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <input onclick="return false;" type="radio" name="calculation_unit" value="1" {{$item->getRawValue('calculation_unit') == '1' ? 'checked' : ''}}>
                        {{__("Line")}}
                    </div>
                    <div class="col-md-4">
                        <input onclick="return false;" type="radio" name="calculation_unit" value="2" {{$item->getRawValue('calculation_unit') == '2' ? 'checked' : ''}}>
                        {{"Application"}}
                    </div>
                </div>
            </div>
            ...
            <div class="form-group">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <input onclick="return false;" type="checkbox" name="incentive_description" value="1" {{$item->getRawValue('incentive_description') == "2" ? 'checked' : ''}}> {{__("Incentive details")}}
                    </div>
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input readonly type="text" name="discount_target1" class="form-control" value="{{$item->discount_target1}}">
            </div>
            <div class="form-group">
                <label>{{__("Discount target 2")}}</label>
                <input readonly type="text" name="discount_target2" class="form-control" value="{{$item->discount_target2}}">
            </div>
            <div class="form-group">
                <label>{{__("Discount target 3")}}</label>
                <input readonly type="text" name="discount_target3" class="form-control" value="{{$item->discount_target3}}">
            </div>
            <div class="form-group">
                <label>{{__("Discount target 4")}}</label>
                <input readonly type="text" name="discount_target4" class="form-control" value="{{$item->discount_target4}}">
            </div>
            <div class="form-group">
                <label>{{__("Discount target 5")}}</label>
                <input readonly type="text" name="discount_target5" class="form-control" value="{{$item->discount_target5}}">
            </div>
